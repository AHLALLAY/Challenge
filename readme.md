...
[W3Schools - SELECT]
[SQLZoo - SELECT]
**Exercices** __(sur une table employes avec id, nom, salaire, departement)__
**Faciles**
...
**Difficiles**
- Dessinez un diagramme avec deux acteurs "Étudiant" et "Professeur", chacun avec deux use cases (ex. "Suivre un Description", "Noter les étudiants").
...
[W3Schools - INSERT]
[W3Schools - UPDATE]
**Exercices** __(table employes : id, nom, salaire, departement)__
**Faciles**
...
**Documentation**
[W3Schools - JOIN]
**Exercices** __(tables employes et departements)__
**Faciles**
